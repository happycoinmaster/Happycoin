...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("HappyCoin-scriptch");
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // HappyCoin: check proof-of-stake block signature
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "happycoin genesis";
        CTransaction txNew;
        txNew.nTime = 1490278404;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1490278404;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 615198; // !fTestNet ? 1575379 : 46534;
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbbe75e143f98a1531fc100ff35e09e9b3b493a0f44014dd9987b5a3a37f9c0c0"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xf3, 0xef, 0xcc };
