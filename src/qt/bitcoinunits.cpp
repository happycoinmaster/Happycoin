...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("HappyCoins"));
    case mBTC: return QString(QObject::tr("Milli-HappyCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-HappyCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
